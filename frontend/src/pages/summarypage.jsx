      ...
      <section className="flex w-full flex-col gap-4 lg:w-[35%] h-full">
        ...
        >
          ...
          <button
            ...
            className="mt-4 rounded-2xl bg-gradient-to-r from-violet-500 via-fuchsia-500 to-sky-400 px-4 py-3 text-sm font-semibold text-slate-950 disabled:opacity-40"
          >
